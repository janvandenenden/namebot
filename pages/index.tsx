...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center p-2 md:p-8" style={{ minHeight: minHeight }}>
      <div className="container mx-auto">
        ...
        <form className="flex flex-col mx-auto py-6 bg-slate-900 md:p-12 p-4 rounded" onSubmit={submitForm}>
          <label htmlFor="businessIdea" className="mb-6 text-sm">
          ...
          <div className="flex flex-col md:flex-row md:items-center">
            <input
              ...
              name="businessIdea"
            ></input>
            <button type="submit" className="bg-indigo-700 p-4 rounded font-bold" disabled={loading}>
              {loading ? (
                <>
